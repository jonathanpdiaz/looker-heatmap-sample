const data = [
  ...
  },
  {
    ...
    attendance_percentage: { value: null, rendered: "null" }
  },
  {
    "location_alerts.pseudo_local_expected_punch_date": {
      value: "2018-07-30",
  ...
  },
  {
    ...
    attendance_percentage: { value: 0.71, rendered: "0.71" }
  },
  {
    "location_alerts.pseudo_local_expected_punch_date": {
      value: "2018-07-27",
    ...
    attendance_percentage: { value: 0.4, rendered: "0.4" }
  },
  {
    "location_alerts.pseudo_local_expected_punch_date": {
      value: "2018-07-28",
...
const queryResponse = {
  parent_id: "e634f07d209455d18870b2a80844e017",
  sql_changed: false,
  added_params: null,
  drill_menu_build_time: 0.032284,
  expired: false,
  fields: {
    measures: [],
    dimensions: [
      {
        ...
        description: null,
        enumerations: null,
        field_group_label: "Pseudo Local Expected Punch Date",
        fill_style: "range",
        ...
        is_filter: false,
        is_numeric: false,
        label: "Location Alerts Pseudo Local Expected Punch Date",
        label_from_parameter: null,
        label_short: "Pseudo Local Expected Punch Date",
        lookml_link:
          "/projects/Customer_Portal/files/location_alerts.view.lkml?line=122",
        map_layer: null,
        name: "location_alerts.pseudo_local_expected_punch_date",
        permanent: null,
        ...
        source_file_path: "Customer_Portal/location_alerts.view.lkml",
        suggest_dimension: "location_alerts.pseudo_local_expected_punch_date",
      ...
      },
      {
        ...
        is_filter: false,
        is_numeric: false,
        label: "Location Alerts Shift",
        label_from_parameter: null,
        label_short: "Shift",
        lookml_link:
          "/projects/Customer_Portal/files/location_alerts.view.lkml?line=165",
        map_layer: null,
        name: "location_alerts.shift",
        permanent: null,
        requires_refresh_on_sort: false,
        sortable: true,
        suggestions: null,
        ...
        source_file: "location_alerts.view.lkml",
        source_file_path: "Customer_Portal/location_alerts.view.lkml",
        suggest_dimension: "location_alerts.shift",
        suggest_explore: "location_alerts",
        suggestable: true,
        is_fiscal: false,
        is_timeframe: false,
  ...
  tracked_attributes: {
    "result.drill_menu_build_time": 0.032284,
    "result.from_cache": false,
    "result.runtime": "0.163",
    "result.sql.length": 1192,
  ...
  query_fields: {
    measures: [
      {
        ...
        lookml_link:
          "/projects/Customer_Portal/files/location_alerts.view.lkml?line=67",
        map_layer: null,
      ...
      },
      {
        ...
        lookml_link:
          "/projects/Customer_Portal/files/location_alerts.view.lkml?line=105",
        map_layer: null,
    ...
    dimensions: [
      ...
      },
      {
        ...
        label_short: "Name",
        lookml_link:
          "/projects/Customer_Portal/files/locations.view.lkml?line=124",
        map_layer: null,
        name: "locations.name",
        permanent: null,
        requires_refresh_on_sort: false,
        ...
        source_file_path: "Customer_Portal/locations.view.lkml",
        suggest_dimension: "locations.name_suggest",
        suggest_explore: "locations",
        suggestable: true,
        is_fiscal: false,
        is_timeframe: false,
        can_time_filter: false,
